      ...
      <form method="post" action="{{route('post.update', $post)}}" enctype="multipart/form-data">
              ...
              <div class="md:flex items-center mt-8">
                  <div class="w-full flex flex-col">
                    <label for="title" class="font-kaisei leading-none mt-4">紅茶名</label>
              ...
              <div class="w-full flex flex-col">
                  <label for="body" class="font-kaisei leading-none mt-4">おすすめポイント</label>
              ...
              <div class="w-full flex flex-col">
                ...
                @endif
                <label for="image" class="font-kaisei leading-none mt-4">画像 （1MBまで）</label>
                <div>
